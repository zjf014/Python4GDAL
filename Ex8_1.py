...
def copy_geo(array, prototype, xoffset=0, yoffset=0):
    ...
    pt = gdal.Open(prototype)
    gdal_array.CopyDatasetInfo(pt, ds, xoff=xoffset, yoff=yoffset)
    return ds
...
# bands
source = "./Data/tmp/re2003_.tif"

# Output geotiff file name
target = "./Data/pic/ndvi.tif"
...
field = ogr.Open("./Data/shp/dalian_pro.shp")
# Must define a "layer" to keep OGR happy
lyr = field.GetLayer("dalian_pro")
